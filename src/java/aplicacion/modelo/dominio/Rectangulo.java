...
public class Rectangulo {
    ...
    public void ingresarDatos(Punto A, double base, double alt){
        setUnPuntoOrigen(A);
        setBaseRec(base);
        setAlturaRec(alt);
    }
    ...
    public ArrayList<Punto> encontrarNuevoPunto(Punto A, double base, double alt){
        ...
        setUnPuntoB(new Punto(getUnPuntoOrigen().getX()+getBaseRec(),getUnPuntoOrigen().getY()));
        setUnPuntoC(new Punto(getUnPuntoOrigen().getX()+getBaseRec(),getUnPuntoOrigen().getY()+getAlturaRec()));
        setUnPuntoD(new Punto(getUnPuntoOrigen().getX(),getUnPuntoOrigen().getY()+getAlturaRec()));
    ...
    /**
     * @param unPuntoE the unPuntoE to set
     */
    public void setUnPuntoB(Punto unPuntoE) {
        this.unPuntoB = unPuntoE;
    }
